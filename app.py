...
# Credenciales Microsoft de Sodexo
SP_USUARIO  = os.environ.get('SP_USUARIO')   # rodrigo.obando@sodexo.com
SP_PASSWORD = os.environ.get('SP_PASSWORD')  # tu contraseña de Sodexo

# Sites de SharePoint
SITE_COMMAND = os.environ.get('SITE_COMMAND')  # site donde están los BD de nomenclaturas

# Rutas de los archivos BD (dentro del site)
RUTA_BD_CECO     = os.environ.get('RUTA_BD_CECO')
RUTA_BD_ESTADO   = os.environ.get('RUTA_BD_ESTADO')
RUTA_BD_FAMILIA  = os.environ.get('RUTA_BD_FAMILIA')
RUTA_BD_RESP     = os.environ.get('RUTA_BD_RESP')

# Archivo de tickets (puede estar en otro site)
SITE_TICKETS     = os.environ.get('SITE_TICKETS')   # site del archivo de registro
RUTA_BD_TICKETS  = os.environ.get('RUTA_BD_TICKETS')
SHEET_TICKETS    = os.environ.get('SHEET_TICKETS', 'Hoja1')
